...
const rabitfly = document.getElementById("rabitfly")

const internals = {};
internals.W = 500;
internals.H = 500;

internals.randomIntFromInterval = (min, max) => Math.floor(Math.random() * (max - min + 1) + min);
...
rabitfly.appendChild(internals.renderer.domElement); 

internals.camera.position.set(40, 20, 100);
internals.scene.add(internals.camera); // controls
